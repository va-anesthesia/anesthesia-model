...
The VA Enterprise Anesthesia Model is based on **JSON**, the same foundational data model adopted by the international healthcare interoperability standards organizations (HL7 and FHIR),  allowing rapid adoption and use across the VA, Federal health sector, and community care partners. 
